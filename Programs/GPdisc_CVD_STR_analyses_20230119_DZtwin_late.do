...
cap postclose coxreg_cvd
	postfile coxreg_cvd str26  (Model BMIind_ow BMIind_ob PRSind BMIjnt_ow BMIjnt_ob PRSjnt ///
								...
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_analyses_20230119_DZtwin_late_CVDany.dta, replace						
...
/// DZ only
	...
	// BMI + PRS model
	stcox i.BMIlate_cat z_PRS_BMI_PCadj educ sex smoke if(zygosity!=1), strata(pairid)
	lincom 2.BMIlate_cat
	...
	// Interaction model
	stcox i.BMIlate_cat##c.z_PRS_BMI_PCadj educ sex smoke if(zygosity!=1), strata(pairid)
	lincom 2.BMIlate_cat
	...
	stcox i.tert_PRS_BMI i.tert_PRS_BMI#i.BMIlate_cat educ sex smoke if(zygosity!=1), strata(pairid)
	/// 1st quartile
...
translate session.smcl "P:\Dementia_IK\SfoEpi\GPdisc_CVD\Log\GOSH\GPdisc_CVD_STR_analyses_20230119_DZtwin_late.log", replace
