...
use "P:\Dementia_IK\SfoEpi\GPdisc_CVD\Data\GOSH\GPdisc_CVD_STR_adata_20220214.dta", clear
...
cap postclose descriptive
	...
	using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_adata_20220214_late_descriptive.dta, replace
...
cap postclose coxreg_cvd
	postfile coxreg_cvd str20  (sex BMIind_ow BMIind_ob PRSind BMIjnt_ow BMIjnt_ob PRSjnt ///
								...
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_adata_20220214_late_survCVDany.dta, replace
	set more off
	// BMI, categorical
...
cap postclose coxreg_cvd
	postfile coxreg_cvd str20  (sex BMIind_ow BMIind_ob PRSind BMIjnt_ow BMIjnt_ob PRSjnt ///
								BMIint_ow BMIint_ob PRSint BMI_PRSint_ow BMI_PRSint_ob ///
								PRS_c1_ow PRS_c1_ob PRS_c2_ow PRS_c2_ob PRS_c3_ow PRS_c3_ob) ///
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_adata_20220214_late_survCVDns.dta, replace
	set more off
	// BMI, categorical
	stcox i.BMIlate_cat educ, vce(cluster pairid) strata(study sex smoke)
	lincom 2.BMIlate_cat
...
cap postclose coxreg_cvd
	postfile coxreg_cvd str20  (sex BMIind_ow BMIind_ob PRSind BMIjnt_ow BMIjnt_ob PRSjnt ///
								BMIint_ow BMIint_ob PRSint BMI_PRSint_ow BMI_PRSint_ob ///
								PRS_c1_ow PRS_c1_ob PRS_c2_ow PRS_c2_ob PRS_c3_ow PRS_c3_ob) ///
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_adata_20220214_late_survSTROKE.dta, replace
	set more off
	// BMI, categorical
	stcox i.BMIlate_cat educ, vce(cluster pairid) strata(study sex smoke)
	lincom 2.BMIlate_cat
...
translate session.smcl "P:\Dementia_IK\SfoEpi\GPdisc_CVD\Log\GOSH\GPdisc_CVD_STR_analyses_20220214_late.log", replace
