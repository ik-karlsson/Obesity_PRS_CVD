...
cap postclose coxreg_cvd
	postfile coxreg_cvd str20 (PRScat BMIall_ow BMItwin_ow BMIdz_ow BMImz_ow BMIall_ob BMItwin_ob BMIdz_ob BMImz_ob) ///
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_analyses_20221212_twin_late_CVDany.dta, replace
	set more off
	// BMI, categorical, total sample
	stcox i.BMIlate_cat educ sex smoke i.studyn, vce(cluster pairid)
		lincom 2.BMIlate_cat
		local m_BMIall_ow = r(estimate)
		local se_BMIall_ow = r(se)
		local Lci_BMIall_ow = exp(`m_BMIall_ow'-1.96*`se_BMIall_ow')
		local Uci_BMIall_ow = exp(`m_BMIall_ow'+1.96*`se_BMIall_ow')
		local BMIall_ow= string(exp(`m_BMIall_ow'),"%9.2f")+" ("+string(`Lci_BMIall_ow',"%9.2f")+"-"+string(`Uci_BMIall_ow',"%9.2f")+")"  
	lincom 3.BMIlate_cat
		local m_BMIall_ob = r(estimate)
		local se_BMIall_ob = r(se)
		local Lci_BMIall_ob = exp(`m_BMIall_ob'-1.96*`se_BMIall_ob')
		local Uci_BMIall_ob = exp(`m_BMIall_ob'+1.96*`se_BMIall_ob')
		local BMIall_ob= string(exp(`m_BMIall_ob'),"%9.2f")+" ("+string(`Lci_BMIall_ob',"%9.2f")+"-"+string(`Uci_BMIall_ob',"%9.2f")+")"  
	...
	stcox i.BMIlate_cat educ sex smoke, strata(pairid)
		...
		local BMItwin_ow= string(exp(`m_BMItwin_ow'),"%9.2f")+" ("+string(`Lci_BMItwin_ow',"%9.2f")+"-"+string(`Uci_BMItwin_ow',"%9.2f")+")"  
	lincom 3.BMIlate_cat
		...
		local BMItwin_ob= string(exp(`m_BMItwin_ob'),"%9.2f")+" ("+string(`Lci_BMItwin_ob',"%9.2f")+"-"+string(`Uci_BMItwin_ob',"%9.2f")+")"  
	...
	lincom 2.BMIlate_cat
		...
		local BMIdz_ow= string(exp(`m_BMIdz_ow'),"%9.2f")+" ("+string(`Lci_BMIdz_ow',"%9.2f")+"-"+string(`Uci_BMIdz_ow',"%9.2f")+")"  
	lincom 3.BMIlate_cat
		...
		local BMIdz_ob= string(exp(`m_BMIdz_ob'),"%9.2f")+" ("+string(`Lci_BMIdz_ob',"%9.2f")+"-"+string(`Uci_BMIdz_ob',"%9.2f")+")"  
	...
	lincom 2.BMIlate_cat
		...
		local BMImz_ow= string(exp(`m_BMImz_ow'),"%9.2f")+" ("+string(`Lci_BMImz_ow',"%9.2f")+"-"+string(`Uci_BMImz_ow',"%9.2f")+")"  
	lincom 3.BMIlate_cat
		...
		local BMImz_ob= string(exp(`m_BMImz_ob'),"%9.2f")+" ("+string(`Lci_BMImz_ob',"%9.2f")+"-"+string(`Uci_BMImz_ob',"%9.2f")+")"  
	...
	set more off
	// BMI, categorical, total sample
	stcox i.BMIlate_cat educ sex smoke i.studyn if(tert_PRS_BMI==`j'), vce(cluster pairid)
		lincom 2.BMIlate_cat
		local m_BMIall_ow = r(estimate)
		local se_BMIall_ow = r(se)
		local Lci_BMIall_ow = exp(`m_BMIall_ow'-1.96*`se_BMIall_ow')
...
translate session.smcl "P:\Dementia_IK\SfoEpi\GPdisc_CVD\Log\GOSH\GPdisc_CVD_STR_analyses_20221212_twin_late.log", replace
