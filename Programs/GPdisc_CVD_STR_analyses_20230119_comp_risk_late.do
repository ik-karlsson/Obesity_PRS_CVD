...
cap postclose coxreg_cvd
	postfile coxreg_cvd str26  (sex BMIind_ow BMIind_ob PRSind BMIjnt_ow BMIjnt_ob PRSjnt ///
								...
								using P:\Dementia_IK\SfoEpi\GPdisc_CVD\Output\GOSH\GPdisc_CVD_STR_analyses_20230119_comp_risk_late_CVDany.dta, replace
	set more off
	// BMI, categorical
...
translate session.smcl "P:\Dementia_IK\SfoEpi\GPdisc_CVD\Log\GOSH\GPdisc_CVD_STR_analyses_20230119_comp_risk_late.log", replace
